...
### 📦 Crates (Signature Stacks)
More than just playlists, Crates are metadata-rich collections.
* **Deep Metadata:** Tracks genre, BPM, and total duration.
* **Privacy Controls:** Public or private crate visibility.
* **Visual Customization:** Custom cover art uploading with automatic cache busting.
